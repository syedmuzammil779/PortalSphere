...
export const action: ActionFunction = async ({ request }) => {
    ...
    try {
        if(customerIds.length <= 0){
            return redirect("/app/buyer-group");
        }
        ...
        <>
            {isLoading ? (
                ...
                <>
                    ...
                    <Page fullWidth>
                        <div className="mx-auto p-6 bg-[rgb(241,242,244)] min-h-screen">
                            <div className="mb-6">
                                <PageHeader 
                                    title="Assign Buyers" 
                                    subtitle={groupName || ""}
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                {/* Left column: Section header/description */}
                                <div className="lg:col-span-1 space-y-6">
                                    <div className="rounded-lg p-6">
                                        <h2 className="text-lg font-semibold text-gray-900 mb-1">Assign Buyer</h2>
                                        <p className="text-sm text-gray-500 mb-4">Select and assign buyers to this group. You can search, select multiple buyers, and assign them in bulk.</p>
                                    </div>
                                </div>
                                {/* Right column: Main card with search, table, actions */}
