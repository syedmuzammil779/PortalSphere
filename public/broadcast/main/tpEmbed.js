...
function insertTopSeller() {
    ...
    if (cartDrawer) {
        ...
        if (drawerInner) {
            ...
            const drawerFooter = drawerInner.querySelector('.drawer__foot');
            ...
            topsellerTitle.style.fontSize = "1.4rem"
            ...
            topProductState.addToCartTopProduct.onclick = async () => {
              ...
              document.getElementById("top-product-embed").style.display = "none"
              fetchTopSeller();
            };
    ...
    function checkCartDrawerAndToggle() {
      const cartDrawer = document.querySelector('div.drawer__body');
      if (cartDrawer) {
