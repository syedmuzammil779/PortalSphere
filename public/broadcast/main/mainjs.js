  ...
  window.cartService = {
    addProductToCart: async function(variantId, quantity, properties = {}) {
      try {
        ...
        document.dispatchEvent(new Event("theme:cart:toggle"))
      } catch (error) {
...
if (!window.GlobalVariables.isGlobalClickEventAdded ) {
  ...
  const addToCartProductButton = document.querySelector('button[name="add"][type="submit"]');
  if(addToCartProductButton) {
    addToCartProductButton.addEventListener('click', async function(event) {
      ...
      if (form) {
        const variantId = form.querySelector('[name="product-id"]')?.value;
  ...
  const variantSelector = document.querySelector('div.product__selectors');
  if(variantSelector) {
      ...
      if (!window.productPageState.productOriginalFlag) {
        const qtyElement = `
          <div id="product-quantity-input-block" style="display: flex; align-items: center; border: 1px solid #ccc; border-radius: 4px; width: fit-content;">
            ...
            <input id="product-quantity-input" style="width: 80px; height: 40px; border: none; font-size: 16px; text-align: center;" value="1" readonly>
      ...
      <div id="complementary-product-block-ui" style="display: none; font-family: Arial, sans-serif; border: 1px solid #ccc; padding: 16px; border-radius: 8px;">
        ...
        <div style="display: flex; align-items: center; margin-bottom: 16px;">
          <div id="complementary-quantity-input-group" style="display: none; border: 1px solid #ccc; border-radius: 4px; width: fit-content; margin-right: 16px;">
            ...
            <input id="complementary-quantity-input" style="width: 60px; height: 40px; border: none; font-size: 16px; text-align: center;" value="1" readonly>
...
if (!window.topSellerPopupService) {
  window.topSellerPopupService = {
    generateTopSellerPopup: function() {
      return `
        <div class="topseller-popup-content" style="max-width: 25rem; background-color: white; height: 100%; padding: 20px;">
            ...
            <div style="padding: 20px; border-top: 1px solid #eee; background: white;">
              <div style="display: flex; align-items: center; margin-bottom: 15px;">
                <div style="display: flex; align-items: center; border: 1px solid #dcdcdc; margin-right: 10px;">
                  ...
                  <input id="cp-ts-quantity-input" style="width: 80px; height: 40px; border: none; border-left: 1px solid #dcdcdc; border-right: 1px solid #dcdcdc; font-size: 16px; text-align: center;" value="1" readonly>
      ...
      <div id="topseller-product-block" style="padding: 10px; position: relative; background-color: #f8faf9;">
        ...
        <div id="top-product-details" style="display: flex; align-items: center; gap: 15px; margin-bottom: 15px;">
          ...
          <div style="flex-grow: 1; display: flex; flex-direction: column">
            ...
            <div id="top-quantity-input-group" style="border: 1px solid #ddd; border-radius: 4px; display: flex; align-items: center; width: fit-content;">
