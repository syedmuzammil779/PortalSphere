...
function insertQuantitySelector(complementaryProduct) {
    ...
    const defaultQuantitySelector = createQuantitySelector()
    let quantitySelector = $("<div data-attr='quantity-selector-div'></div>").html(defaultQuantitySelector).css({
      "display": "flex",
    ...
    quantitySelector = $('div.cp-content').find('div[data-attr="quantity-selector-div"]')
