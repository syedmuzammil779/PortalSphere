...
$(document).ready(async function () {
  ...
  if (tspConfig.enableTopProducts === 'true') {
    ...
    window.triggerTsp = async function () {
        ...
        if (lineItems.length === 0) {
          $("div:has(#close-popup-click-away)").css("display", "flex")
        }
      };
  } else {
            ...
            <div style="padding: 20px; border-top: 1px solid #eee; background: white;">
              <div style="display: flex; align-items: center; margin-bottom: 15px;">
                <div style="display: flex; align-items: center; border: 1px solid #dcdcdc; margin-right: 10px;">
                  <button id="cp-ts-minus" style="width: 40px; height: 40px; background: none; border: none; font-size: 16px; cursor: pointer; color: black;">−</button>
                  ...
                  <button id="cp-ts-plus" style="width: 40px; height: 40px; background: none; border: none; font-size: 16px; cursor: pointer;color: black;">+</button>
                </div>
 ...
 *
 */
function injectListeners(minusBtn, plusBtn, addBtn, volumeData, popupHolder) {
  ...
  $('#close-top-seller-popup').click(() => {
    popupHolder.css("display", "none")
    unlockScroll();
  });
  $('#close-top-seller-nothanks').click(() => {
    popupHolder.css("display", "none")
    unlockScroll();
  });

  $("#close-popup-click-away").click(() => {
    popupHolder.css("display", "none")
    unlockScroll();
  })
}
