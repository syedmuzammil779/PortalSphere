  ...
  $(document).ready(async function() {
    ...
    addBtn.click(async () => {
      ...
      try {
        ...
        $('div[data-div-name="popup-container"]').css("display", "flex")
...
function insertQuantitySelector(complementaryProduct) {
    ...
    const defaultQuantitySelector = $("div.js-qty__wrapper").first()
    let quantitySelector = defaultQuantitySelector.clone(true)

    const plusBtn = quantitySelector.find("button.js-qty__adjust.js-qty__adjust--plus")
    const minusBtn = quantitySelector.find("button.js-qty__adjust.js-qty__adjust--minus")
    ...
    quantitySelector = $('div.cp-content').find('div.js-qty__wrapper')
