...
function insertQuantitySelector(complementaryProduct) {
    ...
    const defaultQuantitySelector = $("quantity-input.quantity").first()
    let quantitySelector = defaultQuantitySelector.clone()

    $('div.cp-content').append(quantitySelector)
    quantitySelector = $('div.cp-content').find('quantity-input')
