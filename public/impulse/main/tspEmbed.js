    ...
    if (tspConfig.enableTopProducts === 'true') {
      ...
      if (addToCartButton) {
        addToCartButton.addEventListener('click', async function () {
          ...
          if (window.productPageState.original.productOriginalQuantityInput.value < volumeConfig.minimum){
            window.productPageState.original.productOriginalQuantityInput.value = window.productPageState.new.productQuantityInput.value;
          } 
