...
function createComplementaryProduct() {
    ...
    const cpAddToCart = document.querySelector("#add-complementary-product")
    cpAddToCart.addEventListener('click', async function () {
...
async function addComplementaryProductToCart() {
    try {
        document.getElementById("add-complementary-product").innerHTML = createSpinner()
        ...
        document.getElementById("add-complementary-product").innerHTML = "Add to cart"
        document.getElementById("complementary-product-block").remove()
    } catch (error) {
