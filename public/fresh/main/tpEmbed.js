...
(function() {
  ...
  function insertTopSeller() {
    ...
    async function tryInsert() {
      const cartDrawer = document.querySelector('#cartSlideoutAside');
      const drawerInner = cartDrawer?.querySelector('#cartSlideoutWrapper');
      const miniCartInner = drawerInner?.querySelector('.cart-items');
